...
This program create 2 keys which are need for RSA encryption, then use this keys to encrypt a messenge and finally we use the Shor's Algorithm to find these keys and decrypt the messange.
